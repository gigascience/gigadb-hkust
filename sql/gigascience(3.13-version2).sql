...
-- Structure for table type (OID = 16452):
CREATE TABLE "type" (
...
CREATE TABLE dataset_external_links (
    external_links_url varchar(30) NOT NULL,
    dataset_identifier varchar(15) NOT NULL
) WITHOUT OIDS;
...
-- Definition for index type_pkey (OID = 16545):
ALTER TABLE ONLY "type"
    ADD CONSTRAINT type_pkey PRIMARY KEY (dataset_identifier, dataset_type);
...
ALTER TABLE ONLY dataset_external_links
    ADD CONSTRAINT foreign_key02 FOREIGN KEY (dataset_identifier) REFERENCES dataset(identifier) ON UPDATE CASCADE ON DELETE CASCADE;
-- Definition for index externel_links_pkey (OID = 16808):
ALTER TABLE ONLY external_links
    ADD CONSTRAINT externel_links_pkey PRIMARY KEY (link_url);
-- Definition for index dataset_external_links_pkey (OID = 16823):
ALTER TABLE ONLY dataset_external_links
