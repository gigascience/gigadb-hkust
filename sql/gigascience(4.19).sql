...
CREATE TABLE image (
    ...
    image_license varchar(250) NOT NULL,
...
-- Definition for index project_pkey (OID = 16960):
ALTER TABLE ONLY project
    ADD CONSTRAINT project_pkey PRIMARY KEY (project_name);
-- Definition for index dataset_project_pkey (OID = 16971):
ALTER TABLE ONLY dataset_project
    ADD CONSTRAINT dataset_project_pkey PRIMARY KEY (identifier, project_name);
-- Definition for index foreign_key02 (OID = 16973):
ALTER TABLE ONLY dataset_project
