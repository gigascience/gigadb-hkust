...
CREATE TABLE species (
	...
	genbank_name character(30),
    scientific_name character(30)
) WITHOUT OIDS;
...
-- Structure for table reserved_dataset 
...
CREATE TABLE excelfile (
	identifier character varying(15) NOT NULL,
	excelfile_name character varying(50) NOT NULL,
...
-- Definition for index Foreign_key02 (OID = 16926):
ALTER TABLE ONLY dataset
...
-- Definition for index author_pkey (OID = 16940):
ALTER TABLE ONLY author
    ADD CONSTRAINT author_pkey PRIMARY KEY (author_name, identifier, rank);
-- Definition for index Foreign_key01 (OID = 16993):
ALTER TABLE ONLY file
    ADD CONSTRAINT "Foreign_key01" FOREIGN KEY (identifier) REFERENCES dataset(identifier) ON UPDATE CASCADE ON DELETE CASCADE;
-- Definition for index dataset_project_pkey (OID = 16998):
ALTER TABLE ONLY dataset_project
    ADD CONSTRAINT dataset_project_pkey PRIMARY KEY (identifier, project_url);
-- Definition for index project_pkey (OID = 17009):
ALTER TABLE ONLY project
    ADD CONSTRAINT project_pkey PRIMARY KEY (project_url);
-- Definition for index Foreign_key01 (OID = 17011):
ALTER TABLE ONLY dataset_project
